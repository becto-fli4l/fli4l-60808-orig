...
\newcommand{\titlename}{Paquetage TEMPLATE - Modèle de documentation pour paquetage}
...
\chapter{Documentation du paquetage TEMPLATE}
\input {template_main}

\appendix
\chapter{Annexe du paquetage TEMPLATE}
