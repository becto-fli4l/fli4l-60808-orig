...
cat<<EOF
<HTML>
<HEAD><TITLE>$(n='fli4l - freifunk.net';echo ${n:-freifunk.net}) -
$TITLE</TITLE>
...
<TD CLASS="color" COLSPAN="5" HEIGHT="19"><SPAN CLASS="color"><A CLASS="color" HREF="cgi-bin-index.cgi">Home</A></SPAN><SPAN CLASS="color"></SPAN></TD>
...
</TR><TR><TD CLASS="magenta" COLSPAN="4" HEIGHT="19">&nbsp;FLI4L - OPT_FREIFUNK Version 1.1.0</TD>
...
for inc in /srv/www2/[0-9][0-9]-*;do cat $inc;done

cat<<EOF
</TABLE></TD><TD VALIGN="top" WIDTH="5"></TD><TD VALIGN="top">
EOF
